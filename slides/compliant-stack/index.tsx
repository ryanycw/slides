...
const TakeawayPrivacy: Page = () => (
  <div style={{ ...fill, background: 'var(--osd-bg)', color: 'var(--osd-text)', padding: '100px 120px' }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 34, marginTop: 52 }}>
      ...
      <Bullet>
        The fix is the identity layer: <B>ZKP + PQ Tunnel</B> — prove, don't upload
      </Bullet>
    </div>
...
export const notes: (string | undefined)[] = [
  ...
  'The KYC paradox: the process that is supposed to reduce risk creates a honeypot of IDs and faces. Once leaked, PII powers targeted social engineering — and face data takes it further: deepfaked video calls and voice clones that impersonate you to your family, your colleagues, your bank. The scam no longer pretends to be a stranger; it pretends to be you. This is why the identity layer's answer — ZK proofs so you never upload the document, post-quantum tunnels so the transport stays sealed (stack Layer 1, not blockchain L1) — is not a privacy luxury but a security requirement.', // 18 Takeaway Privacy
